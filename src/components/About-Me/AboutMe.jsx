...
const AboutMe = () => {
  ...
  return <Section><section className='min-h-screen flex flex-col justify-start items-center p-5 text-center dark:bg-gray-800'>
    ...
    <h3 className='py-3 text-2xl text-gray-600 font-bold dark:text-teal-400'> Software Engineer</h3>
